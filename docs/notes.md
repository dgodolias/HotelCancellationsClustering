...
## 9. Περαιτερω Βελτιστοποίηση: Αφαίρεση Arrival_Month
...
Βέλτιστο k για K-Means (Silhouette): k=4 (Score: 0.4873)
Βέλτιστο k για Hierarchical (Silhouette): k=4 (Score: 0.4858)

Μέγιστη συμφωνία (NMI): k=4 (Score: 0.9755)
Μέγιστη συμφωνία (ARI): k=4 (Score: 0.9884)
============================================================
