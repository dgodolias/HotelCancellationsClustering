...
Ο στόχος αυτής της εργασίας είναι η ανάλυση δεδομένων κρατήσεων ξενοδοχείων για τον εντοπισμό διακριτών τμημάτων πελατών (clusters) με βάση τις συμπεριφορές και τα χαρακτηριστικά των κρατήσεών τους. Κατανοώντας αυτά τα τμήματα, στοχεύουμε να αποκτήσουμε γνώσεις σχετικά με τα μοτίβα ακυρώσεων.
...
1. **K-Means Clustering**:
   ...
   - **Απόσταση**: Ευκλείδεια απόσταση (Euclidean distance).
...
2. **Ιεραρχική Ομαδοποίηση (Hierarchical Clustering)**:
   ...
   - **Μέθοδος Διασύνδεσης (Linkage)**: `ward.D2`. Η μέθοδος Ward ελαχιστοποιεί τη διακύμανση (variance) μέσα στις ομάδες κατά τη συγχώνευση, οδηγώντας σε συμπαγείς και σφαιρικές ομάδες, παρόμοιες με αυτές του K-Means.
